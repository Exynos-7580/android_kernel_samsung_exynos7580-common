...
static gpu_dvfs_info gpu_dvfs_table_default[] = {
	...
	{160,  700000, 0,  35,  80, 1, 0, 273000, 200000,   	 0, CPU_MAX},
	{100,  700000, 0,  30,  80, 1, 0, 200000, 200000,   	 0, CPU_MAX},
};
...
static gpu_attribute gpu_config_attributes[] = {
...
#if defined(CONFIG_MALI_INTERACTIVE)
	{GPU_GOVERNOR_TYPE, G3D_DVFS_GOVERNOR_INTERACTIVE},
#elif defined(CONFIG_MALI_STATIC)
	{GPU_GOVERNOR_TYPE, G3D_DVFS_GOVERNOR_STATIC},
#elif defined(CONFIG_MALI_BOOSTER)
	...
	{GPU_TEMP_THROTTLING3, 534},
	{GPU_TEMP_THROTTLING4, 440},
	{GPU_TEMP_THROTTLING5, 350},
	{GPU_TEMP_THROTTLING6, 266},
	{GPU_TEMP_THROTTLING7, 160},
	{GPU_TEMP_THROTTLING8, 100},
